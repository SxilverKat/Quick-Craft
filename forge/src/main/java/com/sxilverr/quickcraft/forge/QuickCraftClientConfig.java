...
public final class QuickCraftClientConfig {
    ...
    private static final ForgeConfigSpec.ConfigValue<String> COLOR_AVAILABLE = color(
            "colorAvailable", "FF55FF55", "Color for items you already have. Hex like FF55FF55 or 55FF55.");
    private static final ForgeConfigSpec.ConfigValue<String> COLOR_CRAFTED = color(
            "colorCrafted", "FFFFC64B", "Color for items that will be crafted.");
    private static final ForgeConfigSpec.ConfigValue<String> COLOR_MISSING = color(
            "colorMissing", "FFFF5555", "Color for missing materials.");
    private static final ForgeConfigSpec.ConfigValue<String> COLOR_NO_STATION = color(
            "colorNoStation", "FF5A5A5A", "Color for steps you have no station to craft.");
    private static final ForgeConfigSpec.ConfigValue<String> COLOR_TARGET = color(
            "colorTarget", "FF4AA3FF", "Color for the item you are crafting.");
    private static final ForgeConfigSpec.ConfigValue<String> COLOR_NODE_BACKGROUND = color(
            "colorNodeBackground", "F01A1A1A", "Fill color behind each step.");
    private static final ForgeConfigSpec.ConfigValue<String> COLOR_LINES = color(
    ...
    private static ForgeConfigSpec.BooleanValue ENTITY_SPIN;
    private static ForgeConfigSpec.BooleanValue ENTITY_IDLE;
    private static ForgeConfigSpec.BooleanValue ENTITY_WALK;
    private static ForgeConfigSpec.DoubleValue ENTITY_SPIN_SPEED;
    private static ForgeConfigSpec.BooleanValue SHOW_EMC;
    ...
    private static boolean jerLoaded() {
        try {
            return net.minecraftforge.fml.ModList.get().isLoaded("jeresources");
        } catch (Throwable t) {
            return false;
        }
    }
    ...
    private static boolean projectELoaded() {
        try {
            return net.minecraftforge.fml.ModList.get().isLoaded("projecte");
        } catch (Throwable t) {
            return false;
        }
    }
    ...
    private static ForgeConfigSpec.ConfigValue<String> color(String name, String def, String comment) {
