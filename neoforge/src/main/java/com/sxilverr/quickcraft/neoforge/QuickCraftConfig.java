...
public class QuickCraftConfig {
    ...
    private static final ModConfigSpec.ConfigValue<List<? extends String>> PREFERRED_ITEMS = BUILDER
    ...
    private static final ModConfigSpec.IntValue CONTAINER_SCAN_RANGE = BUILDER
    ...
    private static final ModConfigSpec.ConfigValue<List<? extends String>> DEPOSIT_BLACKLIST = BUILDER
    ...
    private static final ModConfigSpec.ConfigValue<List<? extends String>> EXTRA_SOURCES = BUILDER
    ...
    private static final ModConfigSpec.BooleanValue PINNED_LIST_ANIMATION = BUILDER
            .comment("The pinned (bookmarked) ingredients list eases its rows in when it appears.")
            .define("pinnedListAnimation", true);

    private static final ModConfigSpec.BooleanValue HIDE_LOOPING_RECIPES = BUILDER
    ...
    private static final ModConfigSpec.BooleanValue OPEN_ONLY_WITH_RECIPE = BUILDER
    ...
    private static final ModConfigSpec.BooleanValue HOVER_BULGE = BUILDER
            .comment("Tab bulges when hovering over it")
            .define("hoverBulge", true);

    private static final ModConfigSpec.BooleanValue SIZE_TAB_TO_FIT = BUILDER
            .comment("Size a tab to fit a item name")
            .define("sizeTabToFit", true);

    private static final ModConfigSpec.ConfigValue<String> SHIFT_CRAFT_AMOUNT = BUILDER
    ...
    private static final ModConfigSpec.BooleanValue USE_PROJECT_E_EMC = BUILDER
    ...
    private static final ModConfigSpec.BooleanValue USE_KLEIN_STAR_EMC = BUILDER
